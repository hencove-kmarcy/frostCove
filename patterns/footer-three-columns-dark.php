 ...
 * Slug: frostcove/footer-three-columns-dark
 * Categories: footer
...
<!-- wp:paragraph -->
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'frostcove' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'frostcove' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'frostcove' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'frostcove' ); ?></a></p>
<!-- /wp:paragraph -->
